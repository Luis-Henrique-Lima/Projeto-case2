...
export default class ApplicationModel {
    ...
    // =============================================== Métodos estáticos públicos do construtor ===============================================
    static getTableName() {
    ...
    static async findAll() {
        ...
        await connection.close()
        // Converte o resultado do banco para as models
        return all.map( result => this._toModel(result) )
    }

    static async findByProperty(property, value) {
        const connection = await getConnection()
        // Converte o nome da propriedade em nome da coluna no banco
        ...
        // Converter o resultado para propriedade "chaves ou atributos" da model
